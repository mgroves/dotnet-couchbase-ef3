...
{
    public class CouchbaseExecutionStrategy : ExecutionStrategy
    {
        /// <summary>
        ///     Creates a new instance of <see cref="CouchbaseExecutionStrategy" />.
        /// </summary>
        ...
        /// </remarks>
        public CouchbaseExecutionStrategy(
        ...
        public CouchbaseExecutionStrategy([NotNull] DbContext context, int maxRetryCount, TimeSpan maxRetryDelay)
        ...
        /// <param name="maxRetryCount"> The maximum number of retry attempts. </param>
        /// <param name="maxRetryDelay"> The maximum delay between retries. </param>
        public CouchbaseExecutionStrategy([NotNull] ExecutionStrategyDependencies dependencies, int maxRetryCount, TimeSpan maxRetryDelay)
