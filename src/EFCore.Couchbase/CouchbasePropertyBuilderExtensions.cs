...
{
    /// <summary>
    ///     Couchbase-specific extension methods for <see cref="PropertyBuilder" />.
    /// </summary>
    public static class CouchbasePropertyBuilderExtensions
    {
        /// <summary>
        ///     Configures the property name that the property is mapped to when targeting Azure Couchbase.
        /// </summary>
        ...
        public static PropertyBuilder ToProperty(
            ...
            => propertyBuilder.GetInfrastructure<InternalPropertyBuilder>()
                .Couchbase(ConfigurationSource.Explicit)
                .ToProperty(name)
                ? propertyBuilder
                : propertyBuilder;
