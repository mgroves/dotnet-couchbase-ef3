...
{
    public class CouchbaseMemberAccessBindingExpressionVisitor : RelinqExpressionVisitor
    {
        private readonly QuerySourceMapping _querySourceMapping;
        private readonly CouchbaseQueryModelVisitor _queryModelVisitor;
        private readonly bool _inProjection;

        public CouchbaseMemberAccessBindingExpressionVisitor(
            QuerySourceMapping querySourceMapping,
            EntityQueryModelVisitor queryModelVisitor,
            bool inProjection)
        {
            _querySourceMapping = querySourceMapping;
            _queryModelVisitor = (CouchbaseQueryModelVisitor)queryModelVisitor;
