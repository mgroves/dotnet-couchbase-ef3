...
{
    /// <summary>
    ///     Couchbase-specific extension methods for <see cref="ModelBuilder" />.
    /// </summary>
    public static class CouchbaseModelBuilderExtensions
    {
            ...
            [CanBeNull] string name)
        {
            ...
            modelBuilder.GetInfrastructure().Couchbase(ConfigurationSource.Explicit).HasDefaultContainerName(name);
