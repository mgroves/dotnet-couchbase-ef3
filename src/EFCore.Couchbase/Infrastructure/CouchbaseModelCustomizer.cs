...
namespace Microsoft.EntityFrameworkCore.Couchbase.Infrastructure
{
    ...
    ///     </para>
    /// </summary>
    public class CouchbaseModelCustomizer : ModelCustomizer
    {
        public CouchbaseModelCustomizer(ModelCustomizerDependencies dependencies)
            : base(dependencies)
        {
        }
        ...
        {
            modelBuilder.GetInfrastructure().Couchbase(ConfigurationSource.Convention).HasDefaultContainerName(context.GetType().Name);
