...
{
    public class OwnedQueryCouchbaseTest : OwnedQueryTestBase<OwnedQueryCouchbaseTest.OwnedQueryCouchbaseFixture>
    {
        public OwnedQueryCouchbaseTest(OwnedQueryCouchbaseFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
            ClearLog();
...
WHERE (((c[""Discriminator""] = ""LeafB"") OR ((c[""Discriminator""] = ""LeafA"") OR ((c[""Discriminator""] = ""Branch"") OR (c[""Discriminator""] = ""OwnedPerson"")))) AND (c[""PersonAddress""][""Country""][""Name""] = ""USA""))");
        ...
        public class OwnedQueryCouchbaseFixture : OwnedQueryFixtureBase
        {
