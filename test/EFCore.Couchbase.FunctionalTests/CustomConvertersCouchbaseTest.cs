...
{
    public class CustomConvertersCouchbaseTest : CustomConvertersTestBase<CustomConvertersCouchbaseTest.CustomConvertersCouchbaseFixture>
    {
        public CustomConvertersCouchbaseTest(CustomConvertersCouchbaseFixture fixture)
            : base(fixture)
        {
        }
        ...
        public class CustomConvertersCouchbaseFixture : CustomConvertersFixtureBase
        {
